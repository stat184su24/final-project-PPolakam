...
- What
  - This dataset lists each of the kanjis registered in the [Joyo Kanji](https://en.wikipedia.org/wiki/List_of_j%C5%8Dy%C5%8D_kanji), associating them with several key variables.
    - `old`
      ...
      - Japanese simplification was rather conservative, so this column has many NA values.
    ...
    - `year_added`
      ...
      - This variable is also one in which the border between categorical and quantitative is blurred, but given that we most often use
      years categorically, I consider this to be a categorical variable.
